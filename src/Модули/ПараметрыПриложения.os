...
Функция ИмяКомандыИмпортировать() Экспорт
	Возврат "import";
КонецФункции
...
Процедура НастроитьКомандыПриложения(Знач Приложение) Экспорт
	...
	Приложение.ДобавитьКоманду(ИмяКомандыИмпортировать(), "КомандаИмпортировать", "Отправляет данные из карты в гитхаб");
	//...
